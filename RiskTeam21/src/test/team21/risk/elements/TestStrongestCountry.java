 ...
 * @version 2.0.0
 */
public class TestStrongestCountry {
    ...
    public void testStrongestCountry(){
    	Country strong_country=player1.getAssignedCountries().get(0);
    	strong_country.setCurrentArmiesDeployed(500);

    	String result=strong_country.getCountryName();
    	Country actual=player1.getStrongestCountry();
    	
    	assertEquals(result, actual.getCountryName());
    }
