 ...
 * @version 2.0.0
 */
public class TestWeakestCountry {
    ...
    public void testStrongestCountry(){
    	Country weak_country=player1.getAssignedCountries().get(0);
    	weak_country.setCurrentArmiesDeployed(1);

    	String result=weak_country.getCountryName();
    	Country actual=player1.getWeakestCountry();
