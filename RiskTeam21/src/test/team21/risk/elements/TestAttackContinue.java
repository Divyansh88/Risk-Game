 ...
 * @version 2.0.0
 */
public class TestAttackContinue {
     ...
     */
    @Test
    public void testAttackContinue1(){

    	for(Country c:player1.getAssignedCountries()){
    		c.setCurrentArmiesDeployed(1);
    	}
    	
    	player1.checkCanContinue(game_view);
    	assertEquals(false, player1.isCanAttack());
    }
     ...
     */
    @Test
    public void testAttackContinue2(){

    	player1.checkCanContinue(game_view);
    	assertEquals(true, player1.isCanAttack());
    }
}
